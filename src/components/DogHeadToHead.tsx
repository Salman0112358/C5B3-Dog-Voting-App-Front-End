  ...
  return (
    <>
      ...
      <div className="dog_pictures_container">
        <div className="wrapper">
          <div
            className="card"
            onClick={async () =>
              await changeImageForBreed(dogComparer[0].breed, 0)
            }
          >
            <img
              className="dog_image"
        ...
        <div className="wrapper">
          <div
            className="card"
            onClick={async () =>
              await changeImageForBreed(dogComparer[1].breed, 1)
            }
          >
            <img
      ...
      <div className="current_votes">
        <h3>
          You have voted {voteCount} time{voteCount === 1 ? "" : "s"} this
          session out of {totalVotes} total votes
        </h3>
      </div>
    </>
  );
